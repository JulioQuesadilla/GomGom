...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `fk_pedidos_gomitas` FOREIGN KEY (`gomitas_id_gomitas`) REFERENCES `gomitas` (`id_gomitas`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pedidos_has_chamoy` FOREIGN KEY (`id_has_chamoy`) REFERENCES `has_chamoy` (`id_has_chamoy`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pedidos_paquetes` FOREIGN KEY (`paquetes_id_paquetes`) REFERENCES `paquetes` (`id_paquetes`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ventas` (
  ...
  KEY `fk_ventas_pedidos_idx` (`id_pedidos`),
  KEY `fk_ventas_usuarios` (`id_usuario`),
  CONSTRAINT `fk_ventas_pedidos` FOREIGN KEY (`id_pedidos`) REFERENCES `pedidos` (`id_pedidos`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2022-08-11 22:09:36
